...
検出された周波数成分の最大値$f_{max}$[Hz]と最小値$f_{min}$[Hz]の差を100分率で表したものである\cite{ref09}．
...
\begin{figure}[htbp]
    \centering
     \includegraphics[width=0.8\textwidth]{figures/grid_wave.png}
    \caption{系統連系システムのシミュレーション結果}
...
\begin{figure}[htbp]
    \centering
     \includegraphics[width=0.8\textwidth]{figures/quasi_dq_sim.png}
    \caption{提案法による疑似dq変換を用いたPLL制御のシミュレーション結果}
...
\begin{table}[ht]
 ...
 \hline \hline
    ...
    10MHzベース PLL  & 3.192[\%] \\ \hline
    1MHzベース PLL & 3.494[\%]  \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[htbp]
    \centering
     \includegraphics[width=0.8\textwidth]{figures/sim_no_h.png}
    \caption{定常状態}
    \label{fig:without}
\end{figure}
...
\begin{figure}[htbp]
    \centering
     \includegraphics[width=0.8\textwidth]{figures/sim_with_h.png}
    \caption{5次高調波20$\%$，11次高調波30$\%$を重畳した場合}
    \label{fig:with}
\end{figure}

\begin{figure}[htbp]
    \centering
     \includegraphics[width=0.8\textwidth]{figures/f_step.png}
    \caption{周波数を50Hzから55Hzにステップ変化させた場合}
    \label{fig:f_step}
\end{figure}
